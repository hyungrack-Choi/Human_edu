...
public class DateTimeOperationEx {
	...
	public static void main(String[] args) {
		...
		//날짜, 시간의 연산
		LocalDateTime targetDateTime1
		= now.plusYears(1).minusMonths(2).plusDays(3).plusHours(4).minusMinutes(5).plusSeconds(6);
		System.out.println("타겟시간1 : "+ targetDateTime1.toString());
		//날짜, 시간의 직접 변경
		LocalDateTime targetDateTime2
		= now.withYear(2024).withMonth(8).withDayOfMonth(20).withHour(11);
		System.out.println("타겟시간2 : "+ targetDateTime2);
		
		//각 날자의 특징에 따른 날짜 시간 구해오기
		...
		LocalDateTime targetDateTime5 = now.with(TemporalAdjusters.firstDayOfNextMonth());
